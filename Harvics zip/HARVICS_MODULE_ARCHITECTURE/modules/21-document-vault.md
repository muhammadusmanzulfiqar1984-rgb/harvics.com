...
S3/object storage; presigned URLs; version control.

## 2. Purpose

Document Vault stores controlled documents and metadata.
...
### 5.6 Delete according to retention policy
...
- No module-specific AI behaviour is explicitly defined in the source material.
