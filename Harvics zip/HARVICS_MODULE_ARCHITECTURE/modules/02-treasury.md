# Module 02 — Treasury & Banking

**Plane:** OS / Finance  
**Owner domain:** Treasury  
**Current status:** TARGET / implementation status UNKNOWN

## 1. Source-defined scope

Treasury Management; Bank Register; MT940 Import; Auto-Reconciliation; Payment Factory; Cash Dashboard; Cash Pooling; Debt Register; Hedge Accounting; FX Exposure.

## 2. Purpose

Treasury owns bank/cash position, reconciliation, liquidity, debt and hedge records.
