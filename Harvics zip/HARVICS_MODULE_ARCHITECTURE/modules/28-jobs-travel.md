...
Job listings; applications; status tracking; travel events; trips; destination guides; skill-based connections.

## 2. Purpose

People network, employment and travel discovery.
...
Supreme plan specifies full-time, part-time and freelance jobs plus travel events, community trips and destination guides.
