...
Inspection Plans; QC Inspection; NCR; COA; Batch Release Gate; Supplier QC Scorecard; Recall; CAPA; ISO/HACCP/GMP/BRC Audit; Lab Results; Spec vs Actual.

## 2. Purpose

Quality owns inspection and release state. A blocked batch cannot be released downstream.
...
Supreme plan also lists COA, supplier QC scorecard, recall management, ISO/HACCP/GMP/BRC audit, lab results and spec-vs-actual.
