...
**Current status:** S3 approaching S4

## 1. Source-defined scope

Customer 360; Lead Management; Opportunity/Pipeline; Quote/CPQ; Sales Orders; Credit Limits; Pricing; Contracts; Billing; Subscriptions; Loyalty; Rebates; Returns; Support Tickets; SLA.

## 2. Purpose

CRM is the current commercial system of record. HarvyX feeds it; HarvyX is not a second CRM.
...
Supreme plan also lists subscriptions, loyalty, rebates, returns, support tickets and SLA.
