...
Games; tournaments; leaderboards; achievements; server-side verification; anti-cheat; Harvicoins.

## 2. Purpose

Game/competition module.
...
Supreme plan specifies server-side game result verification and anti-cheat.
