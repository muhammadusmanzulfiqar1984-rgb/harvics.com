# Module 31 — HPay Fiat Wallet

**Plane:** Universe / HPay  
**Owner domain:** Universe / HPay  
**Current status:** TARGET / implementation status UNKNOWN

## 1. Source-defined scope

AED + multi-currency; top-up; withdrawal; balance/history.

## 2. Purpose

Consumer wallet surface backed by HPay account/ledger services.
