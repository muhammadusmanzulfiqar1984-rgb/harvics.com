...
Closed-loop spot trading; BTC/ETH/USDT/USDC/DAI; KYC-gated; limits; risk checks; no leverage/derivatives.

## 2. Purpose

Crypto trading must use external regulated/provider rails as applicable; source explicitly excludes leverage and derivatives.
...
Supreme plan specifies no leverage, no derivatives and KYC-gated risk checks.
