...
**Plane:** OS / Commercial  
**Owner domain:** Legal / Compliance  
**Current status:** TARGET / implementation status UNKNOWN

## 1. Source-defined scope

Contract Lifecycle; Templates; Redline/Negotiation; E-Signature; Obligation Tracking; Renewal Alerts; Legal Matter; IP Portfolio; Regulatory Filing; AML/KYB; Counterfeit Detection.

## 2. Purpose

Owns contractual and compliance case state; final legal rules are jurisdiction-specific and must be configured, not invented.
