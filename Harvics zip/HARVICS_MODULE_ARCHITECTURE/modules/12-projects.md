...
Project Portfolio; Gantt/Timeline; Milestones; Resource Allocation; Project P&L; Billable Time; Project Billing; Risk Register; Issue Log; Change Request; Client Portal; Health Dashboard.

## 2. Purpose

Projects owns project delivery state and project-level financial tracking.
...
Supreme plan also lists client portal and health dashboard.
