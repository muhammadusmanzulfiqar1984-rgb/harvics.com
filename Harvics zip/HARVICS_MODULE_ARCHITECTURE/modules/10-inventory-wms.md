...
Stock; Batch/Lot; Serial; Warehouse Bin/Rack/Zone; Put-Away/Pick/Pack; GR/GI; FEFO/FIFO/LIFO; Consignment; UOM; Reorder; Dead Stock.

## 2. Purpose

Inventory is the physical stock source of truth.
...
Supreme plan also lists serial numbers, rack/zone, put-away/pick/pack, consignment, UOM conversion, reorder automation and dead-stock detection.
