...
User Management; RBAC; Permission Matrix; Audit; SSO/MFA; API Keys; Data Retention; Session Management; IP Whitelisting; GDPR/PDPA; System Health.

## 2. Purpose

Admin controls access, security policy and operational administration.
...
Supreme plan lists GDPR/PDPA, API key management, data retention and system health monitoring.
