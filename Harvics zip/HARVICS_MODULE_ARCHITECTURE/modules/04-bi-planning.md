# Module 04 — BI + Planning

**Plane:** OS / Finance  
**Owner domain:** Finance / BI  
**Current status:** TARGET / implementation status UNKNOWN

## 1. Source-defined scope

Budget Planning; Rolling Forecast; Scenario Modelling; P&L by BU/Country/Product; Board Pack; Custom Reports; KPI Library; OKRs; ESG Reporting.

## 2. Purpose

BI is read-model/reporting territory and must not become a second accounting source of truth.
