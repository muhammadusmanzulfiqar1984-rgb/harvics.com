...
const industryMeta: Record<string, { desc: string; gradient: string; image?: string; products: number; markets: number; bg: string; accent: string; bgPhoto: string }> = {
  ...
  finance:        { desc: 'Trade finance, HPay digital payments, and compliance', gradient: 'from-slate-50 to-teal-50', image: '/Images/financial.webp', products: 20, markets: 24, bg: '#f3fdfb', accent: 'rgba(20,184,166,0.12)', bgPhoto: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1400&q=60&fit=crop' },
