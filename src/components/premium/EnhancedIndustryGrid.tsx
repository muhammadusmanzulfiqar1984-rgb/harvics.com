...
const industryMeta: Record<string, { desc: string; gradient: string; image?: string; products: number; markets: number; bg: string; accent: string; bgPhoto: string }> = {
  textiles:       { desc: 'Premium apparel, fabrics, and home textiles for global markets', gradient: 'from-slate-50 to-blue-50', image: `${CDN}/assets/verticals/01-apparels/thumb.webp`, products: 240, markets: 28, bg: '#f8f9ff', accent: 'rgba(59,130,246,0.15)', bgPhoto: `${CDN}/assets/verticals/01-apparels/thumb.webp` },
  fmcg:           { desc: 'Food, beverages, personal care and home essentials', gradient: 'from-slate-50 to-emerald-50', image: `${CDN}/assets/verticals/02-fmcg/thumb.webp`, products: 380, markets: 42, bg: '#f6fdf9', accent: 'rgba(16,185,129,0.15)', bgPhoto: `${CDN}/assets/verticals/02-fmcg/thumb.webp` },
  commodities:    { desc: 'Strategic trading in agriculture, energy, and metals', gradient: 'from-slate-50 to-amber-50', image: `${CDN}/assets/verticals/03-commodities/thumb.webp`, products: 60, markets: 31, bg: '#fdfaf4', accent: 'rgba(195,163,94,0.2)', bgPhoto: `${CDN}/assets/verticals/03-commodities/thumb.webp` },
  industrial:     { desc: 'Advanced chemicals, machinery, and safety equipment', gradient: 'from-slate-50 to-zinc-50', image: `${CDN}/assets/verticals/04-industrial/thumb.webp`, products: 180, markets: 22, bg: '#f8f8f9', accent: 'rgba(113,113,122,0.12)', bgPhoto: `${CDN}/assets/verticals/04-industrial/thumb.webp` },
  minerals:       { desc: 'Precious metals, energy minerals, and industrial resources', gradient: 'from-slate-50 to-stone-50', image: `${CDN}/assets/verticals/05-minerals/thumb.webp`, products: 45, markets: 18, bg: '#faf9f7', accent: 'rgba(120,113,108,0.12)', bgPhoto: `${CDN}/assets/verticals/05-minerals/thumb.webp` },
  'oil-gas':      { desc: 'Complete upstream, midstream, and downstream operations', gradient: 'from-slate-50 to-orange-50', image: `${CDN}/assets/verticals/06-oil-gas/thumb.webp`, products: 30, markets: 15, bg: '#fdf8f3', accent: 'rgba(249,115,22,0.12)', bgPhoto: `${CDN}/assets/verticals/06-oil-gas/thumb.webp` },
  'real-estate':  { desc: 'Commercial and residential property development', gradient: 'from-slate-50 to-cyan-50', image: `${CDN}/assets/verticals/07-real-estate/thumb.webp`, products: 120, markets: 12, bg: '#f3fbfd', accent: 'rgba(6,182,212,0.12)', bgPhoto: `${CDN}/assets/verticals/07-real-estate/thumb.webp` },
  sourcing:       { desc: 'Global sourcing, quality control, and logistics solutions', gradient: 'from-slate-50 to-violet-50', image: `${CDN}/assets/verticals/08-sourcing/thumb.webp`, products: 95, markets: 38, bg: '#f8f5ff', accent: 'rgba(139,92,246,0.12)', bgPhoto: `${CDN}/assets/verticals/08-sourcing/thumb.webp` },
  finance:        { desc: 'Trade finance, HPay digital payments, and compliance', gradient: 'from-slate-50 to-teal-50', image: `${CDN}/assets/verticals/09-finance/thumb.webp`, products: 20, markets: 24, bg: '#f3fdfb', accent: 'rgba(20,184,166,0.12)', bgPhoto: `${CDN}/assets/verticals/09-finance/thumb.webp` },
  ai:             { desc: 'Machine learning, predictive analytics, and automation', gradient: 'from-slate-50 to-pink-50', image: `${CDN}/assets/verticals/10-ai-tech/thumb.webp`, products: 15, markets: 10, bg: '#fdf4fa', accent: 'rgba(236,72,153,0.1)', bgPhoto: `${CDN}/assets/verticals/10-ai-tech/thumb.webp` },
}
