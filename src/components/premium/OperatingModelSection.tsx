...
const OperatingModelSection: React.FC = () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          'radial-gradient(ellipse at 20% 0%, rgba(107,31,43,0.45) 0%, transparent 55%), radial-gradient(ellipse at 80% 100%, rgba(195,163,94,0.18) 0%, transparent 50%), linear-gradient(160deg, #1a0608 0%, #261015 60%, #1a0608 100%)',
      }}
    >
      {/* Subtle grid pattern */}
      <div
