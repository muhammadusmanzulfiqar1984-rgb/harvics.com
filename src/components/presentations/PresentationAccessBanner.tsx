...
export default function PresentationAccessBanner({ verticalKey }: { verticalKey: string }) {
  ...
  return (
    <div className="border border-[#C3A35E]/30 bg-[#3D1212]/95 px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
      ...
      <Link
        ...
        className="inline-flex items-center justify-center px-6 py-2.5 bg-[#C3A35E] text-[#6B1F2B] text-xs font-bold uppercase tracking-[0.14em] hover:bg-[#d4b46e] transition-colors shrink-0"
      >
        Enter {LA_PRES_NAME}
      </Link>
    </div>
