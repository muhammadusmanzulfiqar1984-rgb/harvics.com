...
export default function PinGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(135deg, #3D1212 0%, #1a0a0e 100%)' }}
    >
        ...
        >
          <div className="mb-6">
            <div
              ...
              style={{ background: 'var(--harvics-cream)', border: '1px solid rgba(195, 163, 94,0.3)' }}
            >
              <span className="text-2xl">🔐</span>
            </div>
            <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--harvics-burgundy)' }}>
              Harvics App Store
            </h1>
