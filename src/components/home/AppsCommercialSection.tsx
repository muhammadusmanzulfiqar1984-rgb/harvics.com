...
const APPS: AppSpot[] = [
  {
    ...
    label: 'Secure Comms',
    name: 'Harvoice',
    line: 'Military-grade encrypted messenger — E2EE text, vaults and WebRTC calls.',
    points: ['E2EE', 'WebRTC calls', 'Self-destruct'],
    href: '/apps/harvoice',
    cta: 'Launch Harvoice',
  ...
  },
  {
    ...
    name: 'Harvy',
    nameAccent: 'X',
    line: 'Elite executive concierge — voice, text, flights, hotels and live handoff.',
    points: ['Voice + text', 'Trip workspace', 'Human handoff'],
