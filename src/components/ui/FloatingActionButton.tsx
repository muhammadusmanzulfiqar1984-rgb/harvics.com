  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 rounded-full bg-[#1A0505] text-[#C3A35E] border border-[#C3A35E]/45 hover:border-[#C3A35E] shadow-[0_10px_28px_rgba(26,5,5,0.45)] hover:shadow-[0_12px_32px_rgba(195,163,94,0.35)] transition-all duration-200"
      >
        {/* Soft pulse ring */}
