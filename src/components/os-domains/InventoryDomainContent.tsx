      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Warehouse Locations</h3>
                  ...
                  <tbody>
                    {warehouses.map((w, i) => (
                      <tr key={w.name} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-mono font-semibold text-[#1D1D1F]">{w.name}</td>
                        ...
                        <td className="px-4 py-3 text-center"><span className={`px-2 py-1 text-xs font-bold ${w.status === 'Active' ? 'bg-[#1D1D1F] text-white' : 'bg-[#F5F5F7] text-[#8E8E93]'}`} style={{ borderRadius: 0 }}>{w.status}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Inter-Warehouse Stock Transfers</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[{ id: 'TRF-0841', from: 'WH-DXB-01', to: 'WH-AUH-01', sku: 'HRV-BEV-001', qty: 2400, status: 'In Transit' }, { id: 'TRF-0840', from: 'WH-KHI-01', to: 'WH-LHR-01', sku: 'HRV-SNK-001', qty: 1800, status: 'Completed' }, { id: 'TRF-0839', from: 'WH-SHJ-01', to: 'WH-DXB-01', sku: 'HRV-WTR-001', qty: 5000, status: 'Pending' }, { id: 'TRF-0838', from: 'WH-AUH-01', to: 'WH-SHJ-01', sku: 'HRV-JCE-001', qty: 960, status: 'Completed' }].map((t, i) => (
                      <tr key={t.id} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        ...
                        <td className="px-4 py-3 font-semibold text-[#1D1D1F]">{t.from}</td>
                        ...
                        <td className="px-4 py-3 text-center"><span className={`px-2 py-1 text-xs font-bold ${t.status === 'Completed' ? 'bg-[#1D1D1F] text-white' : t.status === 'In Transit' ? 'bg-[#F5F5F7] text-[#1D1D1F]' : 'bg-[#F5F5F7] text-[#8E8E93]'}`} style={{ borderRadius: 0 }}>{t.status}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-6">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Warehouse Performance Analytics</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[{ label: 'Avg Picking Speed', value: '4.2 min', trend: '+8%' }, { label: 'Order Accuracy', value: '99.1%', trend: '+0.3%' }, { label: 'Inbound per Day', value: '320 pallets', trend: '+12%' }, { label: 'Outbound per Day', value: '284 pallets', trend: '+9%' }].map(k => (
                  <div key={k.label} className="border border-[#E5E5EA]/30 p-4" style={{ borderRadius: 0 }}>
                    ...
                    <div className="text-xs text-[#1D1D1F] font-semibold mt-1">{k.trend} vs last month</div>
                  </div>
                ))}
              </div>
              <div className="overflow-x-auto">
                  ...
                  <tbody>
                    {[{ wh: 'WH-DXB-01', throughput: 420, accuracy: 99.4, util: 81, cost: 0.18 }, { wh: 'WH-AUH-01', throughput: 310, accuracy: 98.9, util: 67, cost: 0.21 }, { wh: 'WH-KHI-01', throughput: 285, accuracy: 99.1, util: 58, cost: 0.14 }].map((w, i) => (
                      <tr key={w.wh} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-mono font-semibold text-[#1D1D1F]">{w.wh}</td>
      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Expiry Alerts</h3>
                  ...
                  <tbody>
                    {expiringBatches.map((a, i) => (
                      <tr key={a.sku} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        ...
                        <td className="px-4 py-3 font-semibold text-[#1D1D1F]">{a.product}</td>
                        ...
                        <td className="px-4 py-3 text-center"><span className={`px-2 py-1 text-xs font-bold ${a.days <= 7 ? 'bg-[#6B1F2B] text-white' : 'bg-[#F5F5F7] text-[#1D1D1F]'}`} style={{ borderRadius: 0 }}>{a.days}d</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-6">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">FEFO / FIFO Picking Rules</h3>
              <div className="space-y-4">
                {[{ wh: 'WH-DXB-01', method: 'FEFO', categories: 'Dairy, Beverages, Fresh Food', active: true }, { wh: 'WH-AUH-01', method: 'FEFO', categories: 'All Perishables', active: true }, { wh: 'WH-KHI-01', method: 'FIFO', categories: 'Dry Goods, Snacks', active: true }, { wh: 'WH-SHJ-01', method: 'FEFO', categories: 'All Categories', active: false }].map((r, i) => (
                  <div key={r.wh} className="flex items-center justify-between p-4 border border-[#E5E5EA]/30 bg-[#F5F5F7]" style={{ borderRadius: 0 }}>
                    <div>
                      <div className="font-semibold text-[#1D1D1F]">{r.wh}</div>
                      <div className="text-xs text-[#8E8E93] mt-0.5">Applies to: {r.categories}</div>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="px-3 py-1 text-xs font-bold bg-[#1D1D1F] text-white" style={{ borderRadius: 0 }}>{r.method}</span>
                      <span className={`px-2 py-1 text-xs font-bold ${r.active ? 'bg-[#1D1D1F] text-white' : 'bg-[#F5F5F7] text-[#8E8E93]'}`} style={{ borderRadius: 0 }}>{r.active ? 'Active' : 'Inactive'}</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-6">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Expiry Loss Reports</h3>
                  ...
                  <tbody>
                    {[{ month: 'Mar 2026', units: 1240, value: '$4,820', cat: 'Dairy' }, { month: 'Feb 2026', units: 980, value: '$3,920', cat: 'Fresh Juice' }, { month: 'Jan 2026', units: 1580, value: '$6,200', cat: 'Dairy' }, { month: 'Dec 2025', units: 2100, value: '$8,400', cat: 'Seasonal' }].map((r, i) => (
                      <tr key={r.month} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-semibold text-[#1D1D1F]">{r.month}</td>
      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Batch / Lot Numbers</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <tbody>
                    {batches.map((b, i) => (
                      <tr key={b.batch} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        ...
                        <td className="px-4 py-3 font-mono text-xs font-semibold text-[#1D1D1F]">{b.sku}</td>
                        ...
                        <td className="px-4 py-3 text-center"><span className={`px-2 py-1 text-xs font-bold ${b.status === 'Active' ? 'bg-[#1D1D1F] text-white' : b.status === 'Expiring' ? 'bg-[#6B1F2B] text-white' : 'bg-[#F5F5F7] text-[#8E8E93]'}`} style={{ borderRadius: 0 }}>{b.status}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Lot Number Tracking</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {lots.map((l, i) => (
                      <tr key={l.lot} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-mono text-xs font-semibold text-[#1D1D1F]">{l.lot}</td>
                        ...
                        <td className="px-4 py-3 text-right font-semibold text-[#1D1D1F]">{l.remaining.toLocaleString()}</td>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Batch Movement History</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {movements.map((h, i) => (
                      <tr key={h.date} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        ...
                        <td className="px-4 py-3"><span className="px-2 py-1 text-xs font-bold bg-[#F5F5F7] text-[#1D1D1F]" style={{ borderRadius: 0 }}>{h.event}</span></td>
                        <td className="px-4 py-3">{h.loc}</td>
                        <td className={`px-4 py-3 text-right font-semibold ${h.qty < 0 ? 'text-[#6B1F2B]' : h.qty > 0 ? 'text-[#1D1D1F]' : 'text-[#8E8E93]'}`}>{h.qty !== 0 ? (h.qty > 0 ? '+' : '') + h.qty.toLocaleString() : '—'}</td>
        ...
        },
        {
          ...
          component: (
            <div className="p-6 space-y-6">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">Full Product Traceability Chain</h3>
                ...
                {[{ step: 1, label: 'Raw Material Sourced', detail: 'Supplier: Al Rawabi Dairy — UAE', date: '2026-01-05', done: true }, { step: 2, label: 'Manufacturing', detail: 'Factory: Dubai Industrial City — Batch BT-2026-0841', date: '2026-01-10', done: true }, { step: 3, label: 'Quality Control', detail: 'QC passed — Certificate No. QC-24821', date: '2026-01-12', done: true }, { step: 4, label: 'Received at Warehouse', detail: 'WH-DXB-01 — Rack B4 — 12,000 units', date: '2026-01-14', done: true }, { step: 5, label: 'Picked & Packed', detail: 'Order ORD-8821 — 240 units to Customer', date: '2026-03-23', done: true }, { step: 6, label: 'Delivered', detail: 'POD signed by: Al Fardan Group', date: '2026-03-23', done: false }].map((s, i, arr) => (
                  <div key={s.step} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div className={`w-8 h-8 flex items-center justify-center text-xs font-bold ${s.done ? 'bg-[#1D1D1F] text-white' : 'bg-[#F5F5F7] text-[#8E8E93] border border-[#E5E5EA]'}`} style={{ borderRadius: 0 }}>{s.step}</div>
                      {i < arr.length - 1 && <div className="w-px flex-1 bg-[#E5E5EA] my-1"></div>}
                    </div>
                    <div className="pb-6">
                      <div className="font-semibold text-[#1D1D1F]">{s.label}</div>
      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1D1D1F] mb-4">SKU Product Catalog</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[{ sku: 'HRV-BEV-001', name: 'Harvics Cola 500ml', cat: 'Beverages', stock: 12500, price: 2.10, status: 'Active' }, { sku: 'HRV-SNK-001', name: 'Harvics Chips 150g', cat: 'Snacks', stock: 8400, price: 2.80, status: 'Active' }, { sku: 'HRV-WTR-001', name: 'Harvics Pure Water 1L', cat: 'Water', stock: 25000, price: 1.10, status: 'Active' }, { sku: 'HRV-JCE-001', name: 'Harvics Mango Juice 330ml', cat: 'Beverages', stock: 6200, price: 1.80, status: 'Active' }].map((p, i) => (
                      <tr key={p.sku} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-mono font-semibold text-[#1D1D1F]">{p.sku}</td>
                        <td className="px-4 py-3">{p.name}</td>
                        <td className="px-4 py-3"><span className="px-2 py-1 text-xs font-bold bg-[#F5F5F7] text-[#1D1D1F]" style={{ borderRadius: 0 }}>{p.cat}</span></td>
                        <td className="px-4 py-3 text-right">{p.stock.toLocaleString()}</td>
                        <td className="px-4 py-3 text-right font-semibold text-[#1D1D1F]">${p.price.toFixed(2)}</td>
                        <td className="px-4 py-3 text-center"><span className="px-2 py-1 text-xs font-bold bg-[#F5F5F7] text-[#1D1D1F]" style={{ borderRadius: 0 }}>{p.status}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
