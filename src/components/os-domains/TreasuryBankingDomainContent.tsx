      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1A1A1A]">Global Liquidity Position</h3>
      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1A1A1A]">Bank Account Register</h3>
                  ...
                  <tbody>
                    {[{ bank: 'HSBC', country: 'UAE', currency: 'USD', balance: '4,820,000' }, { bank: 'Standard Chartered', country: 'Pakistan', currency: 'PKR', balance: '410,000,000' }, { bank: 'Barclays', country: 'UK', currency: 'GBP', balance: '1,180,000' }].map((r, i) => (
                      <tr key={r.bank + r.country} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        <td className="px-4 py-3 font-semibold text-[#1A1A1A]">{r.bank}</td>
