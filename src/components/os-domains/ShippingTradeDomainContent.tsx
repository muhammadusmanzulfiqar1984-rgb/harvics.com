      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1A1A1A]">Shipment Tracker</h3>
      ...
      tier3Screens: [
        {
          ...
          component: (
            <div className="p-6 space-y-4">
              <h3 className="text-xl font-semibold text-[#1A1A1A]">Trade Document Vault</h3>
                  ...
                  <tbody>
                    {[{ shipment: 'SHP-2026-7811', incoterm: 'CIF', status: 'Ocean Transit', compliance: 'Cleared' }, { shipment: 'SHP-2026-7812', incoterm: 'FOB', status: 'Port Hold', compliance: 'Review' }, { shipment: 'SHP-2026-7813', incoterm: 'DAP', status: 'Last Mile', compliance: 'Cleared' }].map((r, i) => (
                      <tr key={r.shipment} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F5F5F7]'}>
                        ...
                        <td className="px-4 py-3 text-center"><span className="px-2 py-1 text-xs bg-[#1A1A1A] text-white" style={{ borderRadius: 0 }}>{r.compliance}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
