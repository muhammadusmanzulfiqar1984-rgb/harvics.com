...
const MOCK: Record<string, any> = {
  crm: {
    totalCustomers: 342, activeCustomers: 298, newCustomers: 31, satisfaction: 94,
    revenueByMonth: [280, 310, 295, 340, 375, 390, 410, 385, 420, 445, 462, 488],
    customersByRegion: [
      { region: 'Middle East', count: 98, revenue: 4200000 },
      { region: 'South Asia', count: 87, revenue: 3100000 },
      { region: 'East Africa', count: 64, revenue: 2400000 },
      { region: 'North America', count: 56, revenue: 5800000 },
      { region: 'Europe', count: 37, revenue: 1900000 },
    ],
    customers: [
    ...
    complaints: [
      { id: 'CP001', customer: 'Pacific Grocers', issue: 'Delivery delay', status: 'Resolved', date: '2 days ago', priority: 'Medium' },
      { id: 'CP002', customer: 'Istanbul Imports', issue: 'Invoice discrepancy', status: 'Open', date: '1 day ago', priority: 'High' },
    ],
  },
  orders: {
