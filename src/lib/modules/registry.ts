...
export const MODULE_REGISTRY: readonly ModuleRegistryEntry[] = [
  ...
  { id: 2, band: 'Finance & Controlling', name: 'Controlling', route: '/api/finance/controlling', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  ...
  { id: 6, band: 'Finance & Controlling', name: 'HPay Payments', route: '/api/finance/hpay', osPath: '/os/payments-digital-finance', intelligence: 'L4', reporting: 'Transaction', status: 'stub' },
  { id: 7, band: 'Finance & Controlling', name: 'Financial Planning', route: '/api/finance/planning', osPath: '/os/financial-planning-bi', intelligence: 'L4', reporting: 'Executive', status: 'stub' },
  ...
  { id: 9, band: 'Commercial & Sales', name: 'CPQ Engine', route: '/api/crm/cpq', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  ...
  { id: 15, band: 'Procurement & Sourcing', name: 'Contract Lifecycle', route: '/api/procurement/contracts', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  { id: 16, band: 'Procurement & Sourcing', name: 'Sourcing Network', route: '/api/procurement/sourcing', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  ...
  { id: 18, band: 'Manufacturing', name: 'Shop Floor Control', route: '/api/manufacturing/floor', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  { id: 19, band: 'Manufacturing', name: 'Bill of Materials', route: '/api/manufacturing/bom', intelligence: 'L2', reporting: 'Operational', status: 'stub' },
  ...
  { id: 21, band: 'Manufacturing', name: 'Recipe Management', route: '/api/manufacturing/recipes', intelligence: 'L2', reporting: 'Operational', status: 'stub' },
  ...
  { id: 23, band: 'Inventory & Warehouse', name: 'Warehouse Management', route: '/api/warehouse', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  { id: 24, band: 'Inventory & Warehouse', name: 'Demand Planning', route: '/api/inventory/demand', intelligence: 'L4', reporting: 'Management', status: 'stub' },
  ...
  { id: 28, band: 'Logistics & Trade', name: '3PL Integration', route: '/api/logistics/3pl', intelligence: 'L2', reporting: 'Operational', status: 'stub' },
  ...
  { id: 30, band: 'Human Capital', name: 'Talent Acquisition', route: '/api/hr/recruitment', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  { id: 31, band: 'Human Capital', name: 'Learning Management', route: '/api/hr/learning', intelligence: 'L2', reporting: 'Operational', status: 'stub' },
  { id: 32, band: 'Human Capital', name: 'Performance & Succession', route: '/api/hr/performance', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  { id: 33, band: 'Human Capital', name: 'Workforce Planning', route: '/api/hr/workforce', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  ...
  { id: 35, band: 'Asset & Maintenance', name: 'Plant Maintenance', route: '/api/maintenance', intelligence: 'L4', reporting: 'Management', status: 'stub' },
  { id: 36, band: 'Asset & Maintenance', name: 'Real Estate & Facilities', route: '/api/facilities', intelligence: 'L2', reporting: 'Operational', status: 'stub' },

  // GRC (37-40)
  { id: 37, band: 'GRC', name: 'GRC Core', route: '/api/grc', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  ...
  { id: 41, band: 'Analytics & Intelligence', name: 'BI & Reporting', route: '/api/bi', osPath: '/os/financial-planning-bi', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  { id: 42, band: 'Analytics & Intelligence', name: 'Board Pack Generator', route: '/api/bi/board', osPath: '/os/executive', intelligence: 'L5', reporting: 'Executive', status: 'stub' },
  { id: 43, band: 'Analytics & Intelligence', name: 'OKR Tracking', route: '/api/bi/okr', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  { id: 44, band: 'Analytics & Intelligence', name: 'AI Variance Commentary', route: '/api/ai/variance', intelligence: 'L5', reporting: 'Executive', status: 'stub' },
  ...
  { id: 46, band: 'Projects & Services', name: 'Service Management', route: '/api/services', intelligence: 'L3', reporting: 'Operational', status: 'stub' },
  { id: 47, band: 'Projects & Services', name: 'Professional Services', route: '/api/projects/psa', intelligence: 'L3', reporting: 'Management', status: 'stub' },
  ...
  { id: 54, band: 'Platform & Infrastructure', name: 'Integration Bus', route: '/api/integration', intelligence: 'L2', reporting: 'Operational', status: 'stub' },
  ...
  { id: 57, band: 'Data & AI', name: 'Harvoice', route: '/api/ai/harvoice', intelligence: 'L5', reporting: 'Interactive', status: 'stub' },
  ...
  { id: 59, band: 'HARVICS Universe', name: 'FunFeed', route: '/api/universe/feed', intelligence: 'L2', reporting: 'Social', status: 'stub' },
  { id: 60, band: 'HARVICS Universe', name: 'Harvics Mall', route: '/api/universe/mall', intelligence: 'L2', reporting: 'B2C', status: 'stub' },
  { id: 61, band: 'HARVICS Universe', name: 'Trade Floor', route: '/api/universe/trade', intelligence: 'L3', reporting: 'B2C', status: 'stub' },
  { id: 62, band: 'HARVICS Universe', name: 'Playroom', route: '/api/universe/games', intelligence: 'L1', reporting: 'Engagement', status: 'stub' },
  { id: 63, band: 'HARVICS Universe', name: 'Experts Hub', route: '/api/universe/experts', intelligence: 'L2', reporting: 'Gig', status: 'stub' },
  { id: 64, band: 'HARVICS Universe', name: 'Jobs + Travel', route: '/api/universe/jobs', intelligence: 'L2', reporting: 'Gig', status: 'stub' },
  { id: 65, band: 'HARVICS Universe', name: 'Crypto Lite', route: '/api/universe/crypto', intelligence: 'L3', reporting: 'Trading', status: 'stub' },
  { id: 66, band: 'HARVICS Universe', name: 'Harvicoins', route: '/api/universe/harvicoins', intelligence: 'L2', reporting: 'Wallet', status: 'stub' },
  { id: 67, band: 'HARVICS Universe', name: 'HPay Wallet', route: '/api/universe/hpay', intelligence: 'L3', reporting: 'Wallet', status: 'stub' },
  { id: 68, band: 'HARVICS Universe', name: 'Circle Referral', route: '/api/universe/referral', intelligence: 'L2', reporting: 'Program', status: 'stub' },

  // Portals (69-71)
  { id: 69, band: 'Portals', name: 'Customer Portal', route: '/api/portals/customer', intelligence: 'L1', reporting: 'B2C', status: 'stub' },
  { id: 70, band: 'Portals', name: 'Vendor Portal', route: '/api/portals/vendor', intelligence: 'L2', reporting: 'B2B', status: 'stub' },
  { id: 71, band: 'Portals', name: 'Field Officer Portal', route: '/api/portals/field', intelligence: 'L2', reporting: 'Field', status: 'stub' },
] as const
