          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {portals.map((portal) => (
              <Link
                key={portal.id}
                href={portal.href}
                className="group bg-white rounded-2xl p-8 border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2"
              >
                <div className="w-16 h-16 rounded-xl bg-[#6B1F2B] text-[#C3A35E] flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300">
                  {portal.icon}
                </div>
      ...
      <section className="py-12 border-t border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            ...
            className="px-6 py-3 rounded-lg bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-[#C3A35E]/30 text-gray-600 hover:text-[#6B1F2B] font-medium transition-all text-sm flex items-center gap-2"
          >
