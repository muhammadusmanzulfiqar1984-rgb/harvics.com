  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20" style={{ color: '#3d1a22' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '36px', fontSize: '15px', lineHeight: 1.75, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', color: '#3d1a22' }}>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>2. Use of the Website</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>3. Intellectual Property</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>4. Accuracy of Information</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>5. Limitation of Liability</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>6. Third-Party Links</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>7. Governing Law</h2>
