...
const APPS = [
  ...
  },
  {
    id: 'harvoice',
    name: 'Harvoice',
    tagline: 'Encrypted P2P Messenger — Military-Grade E2EE',
    description:
      'Advanced encrypted messenger with end-to-end AES-GCM over ECDH, durable offline ciphertext queue, PIN device claim, encrypted vaults, self-destruct, and WebRTC voice/video over STUN/TURN — including cellular.',
  ...
  {
    id: 'harvyx-concierge',
    name: 'HarvyX Concierge',
    tagline: 'Elite Executive AI Concierge',
    description:
      'Military-polished executive concierge — voice + text, flights, hotels, chauffeurs, itineraries, document intake, HPay holds, calendar export, and live human handoff. Built on Gemini Live with Harvics burgundy/gold design.',
    category: 'Secure Communications',
    status: 'live' as const,
    badge: 'LIVE',
    icon: '✨',
    ...
    pricing: [],
    stats: [
      { label: 'AI Engine', value: 'Gemini Live' },
