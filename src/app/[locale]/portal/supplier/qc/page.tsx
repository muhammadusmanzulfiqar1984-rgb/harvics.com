        ...
        <main className="max-w-[1920px] mx-auto px-6 py-6">
          <nav className="mb-6 text-sm">
            <ol className="flex items-center gap-2 text-black">
              ...
              <li>/</li>
              <li className="font-semibold">Quality Control</li>
            </ol>
          </nav>

          <div className="mb-6">
            <h1 className="text-3xl font-bold text-black mb-2">Quality Control</h1>
            <p className="text-black">Tier 2: QC Module - Quality control, testing, inspections, and quality metrics</p>
          </div>
