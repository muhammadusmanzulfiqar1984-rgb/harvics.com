  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-20" style={{ color: '#3d1a22' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '36px', fontSize: '15px', lineHeight: 1.75, fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', color: '#3d1a22' }}>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>1. Who We Are</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>2. Data We Collect</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>3. How We Use Your Data</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--harvics-burgundy)', marginBottom: '10px', letterSpacing: '-0.01em' }}>5. Cookies</h2>
