              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
                ...
                <div className="order-2 lg:order-1">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs font-bold text-harvics-gold uppercase tracking-[0.2em]">Contact Details</span>
                  </div>
                  <h2 className="text-2xl md:text-3xl font-bold text-harvics-burgundy mb-8" style={{ letterSpacing: '-0.02em' }}>{t.getInTouch}</h2>

                  <div className="space-y-3">
                    {contactItems.map((item, i) => (
                      <div
                        key={item.key}
                        className="group flex items-start gap-4 p-5 bg-white/60 border border-harvics-gold/10 hover:border-harvics-gold/40 transition-all duration-300"
                        style={{
                          opacity: cardRef.inView ? 1 : 0,
                      ...
                      >
                        <div className="w-11 h-11 bg-harvics-burgundy flex items-center justify-center flex-shrink-0 group-hover:bg-harvics-gold transition-colors duration-300">
                    ...
                    >
                      ...
                      <div>
                        <h3 className="text-harvics-burgundy font-bold text-sm mb-0.5">{t.locations}</h3>
                        <p className="text-harvics-burgundy/50 text-sm">{t.locationsValue}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="bg-white/80 p-8 border border-harvics-gold/15">
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-6 h-[2px] bg-harvics-gold/50" />
                      <span className="text-xs font-bold text-harvics-gold uppercase tracking-[0.2em]">Send a Message</span>
                    </div>
                    <h2 className="text-2xl font-bold text-harvics-burgundy mb-8" style={{ letterSpacing: '-0.02em' }}>{t.sendMessage}</h2>

                    {formState === 'sent' ? (
                      <div className="text-center py-12">
                        <div className="text-4xl mb-4">✓</div>
                        <h3 className="text-lg font-bold text-harvics-burgundy mb-2">Message Sent</h3>
                        <p className="text-sm text-harvics-burgundy/50">We'll get back to you within 24 hours.</p>
                        <button
                          onClick={() => setFormState('idle')}
                          className="mt-6 text-sm text-harvics-gold border border-harvics-gold/30 px-4 py-2 hover:bg-harvics-gold/5 transition-colors duration-200"
                        >
                          Send Another
                        </button>
                      </div>
                      ...
                      <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-harvics-burgundy font-bold mb-2 text-[10px] uppercase tracking-wider">{t.firstName}</label>
                            <input
                              type="text"
                              className="w-full px-4 py-3 bg-white border border-harvics-gold/20 text-harvics-burgundy text-sm placeholder-[#3D1212]/25 focus:border-harvics-gold focus:outline-none transition-colors duration-200"
                              placeholder={t.firstNamePlaceholder}
                              required
                            />
                          </div>
                          <div>
                            <label className="block text-harvics-burgundy font-bold mb-2 text-[10px] uppercase tracking-wider">{t.lastName}</label>
                            <input
                              type="text"
                              className="w-full px-4 py-3 bg-white border border-harvics-gold/20 text-harvics-burgundy text-sm placeholder-[#3D1212]/25 focus:border-harvics-gold focus:outline-none transition-colors duration-200"
                        ...
                        <div>
                          <label className="block text-harvics-burgundy font-bold mb-2 text-[10px] uppercase tracking-wider">{t.email}</label>
                          <input
                            type="email"
                            className="w-full px-4 py-3 bg-white border border-harvics-gold/20 text-harvics-burgundy text-sm placeholder-[#3D1212]/25 focus:border-harvics-gold focus:outline-none transition-colors duration-200"
                        ...
                        <div>
                          <label className="block text-harvics-burgundy font-bold mb-2 text-[10px] uppercase tracking-wider">{t.subject}</label>
                          <input
                            type="text"
                            className="w-full px-4 py-3 bg-white border border-harvics-gold/20 text-harvics-burgundy text-sm placeholder-[#3D1212]/25 focus:border-harvics-gold focus:outline-none transition-colors duration-200"
                        ...
                        <div>
                          <label className="block text-harvics-burgundy font-bold mb-2 text-[10px] uppercase tracking-wider">{t.message}</label>
                          <textarea
                            rows={4}
                            className="w-full px-4 py-3 bg-white border border-harvics-gold/20 text-harvics-burgundy text-sm placeholder-[#3D1212]/25 focus:border-harvics-gold focus:outline-none transition-colors duration-200 resize-none"
                        ...
                        <button
                          ...
                          className="group relative w-full bg-harvics-burgundy text-white text-sm font-bold uppercase tracking-widest px-8 py-4 overflow-hidden transition-colors disabled:opacity-60"
                        >
        ...
        <section className="relative px-4 py-16">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-harvics-burgundy mb-3">Your Privacy Matters</h2>
              <p className="text-harvics-burgundy/60 max-w-2xl mx-auto">
