        ...
        <section className="py-8 sm:py-12 px-4 sm:px-6">
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#6B1F2B] rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-start space-x-3 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                <div className="w-8 h-8 bg-[#6B1F2B]/10 rounded-lg flex items-center justify-center flex-shrink-0">
