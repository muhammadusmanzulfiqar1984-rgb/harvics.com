...
export default function Module66DocumentPage() {
  ...
  return (
    <HarvicsOSShell
      ...
      subtitle="Module #66 — SAP+ Harvicoins wallet document"
      activeDomain="wallet"
      breadcrumbs={[
        { label: 'OS', href: '/os' },
        { label: 'Harvicoins', href: '/os/wallet' },
        { label: doc ? String(doc.ownerId) : 'Document' },
      ]}
    >
      <div className="space-y-5 p-5 text-harvics-burgundy">
        <Link href={`/${locale}/os/wallet`} className="text-[10px] font-bold uppercase tracking-[0.14em] underline">
          ← Harvicoins workspace
        </Link>
