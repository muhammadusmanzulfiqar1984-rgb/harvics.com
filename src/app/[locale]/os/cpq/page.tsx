...
export default function P(){
  ...
  <Grid cols={3}>
    <Panel title="NEW QUOTE">
      ...
      <div style={{marginTop:8,fontWeight:700,color:'var(--harvics-burgundy)',fontSize:11}}>LINES</div>
    ...
    <Panel title="ALL QUOTES" full>
      <Tbl head={['QUOTE','CUSTOMER','LINES','SUBTOTAL','TOTAL','STATUS','ACTIONS']}>
        {rows.map(r=><tr key={r.id} style={{borderBottom:'1px solid #3D121211'}}>
          ...
          <td style={{...td,fontWeight:700,color:'var(--harvics-burgundy)'}}>{r.currency} {r.total.toLocaleString()}</td>
