  ...
  return (
    <main className="min-h-screen pt-[136px]" style={{ background: '#ffffff' }}>
      ...
      <div>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-harvics-burgundy mb-4 md:mb-6 font-serif">
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl font-medium text-harvics-burgundy mb-2 font-serif">
                Live Crypto (Binance)
              </h2>
        ...
        <section className="relative py-20 md:py-32 bg-harvics-burgundy overflow-hidden">
        ...
        <section className="py-16 md:py-24 bg-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-harvics-gold rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-harvics-gold rounded-full blur-3xl"></div>
          </div>
          
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium text-harvics-burgundy mb-6 font-serif tracking-tight">
              ...
              >
                ...
                <div className="relative p-10 md:p-12 border border-gray-100 hover:border-green-500/30 transition-all duration-500 hover:scale-[1.02] bg-white">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl md:text-3xl font-medium text-harvics-burgundy mb-4 group-hover:text-green-700 transition-colors duration-300 font-serif">
                      Fiat Investment
                    </h3>
              ...
              >
                ...
                <div className="relative p-10 md:p-12 border border-gray-100 hover:border-orange-500/30 transition-all duration-500 hover:scale-[1.02] bg-white">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl md:text-3xl font-medium text-harvics-burgundy mb-4 group-hover:text-orange-700 transition-colors duration-300 font-serif">
                      Bitcoin Investment
                    </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="relative p-8 bg-white border border-gray-100 hover:border-harvics-gold/30 transition-all duration-500 hover:scale-105 hover:shadow-xl group">
                    <div className="text-center">
                      <div className="inline-flex items-center justify-center w-20 h-20 bg-harvics-burgundy/5 mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                        <span className="text-4xl">{info.icon}</span>
                      </div>
                      <h3 className="text-xl md:text-2xl font-medium text-harvics-burgundy mb-3 group-hover:text-harvics-gold transition-colors duration-300 font-serif">
                        {info.title}
                      </h3>
        ...
        <section className="py-16 md:py-24 bg-harvics-burgundy relative overflow-hidden">
          {/* Background decorative elements */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-harvics-gold rounded-full blur-[120px]"></div>
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-harvics-gold rounded-full blur-[120px]"></div>
          </div>
          
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium text-harvics-gold mb-6 font-serif tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
              ...
              <div className="group relative">
                <div className="relative p-8 md:p-10 bg-white/5 backdrop-blur-md border border-white/10 hover:border-harvics-gold transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-[#C3A35E]/10">
                  <div className="flex items-start space-x-6 mb-6">
                    <div className="flex-shrink-0 w-16 h-16 bg-harvics-gold text-harvics-burgundy flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-2xl md:text-3xl font-medium text-white mb-3 group-hover:text-harvics-gold transition-colors duration-300 font-serif">
                        {getTranslation('info.financials.title', 'Financial Performance')}
                      </h3>
                      <div className="w-16 h-0.5 bg-harvics-gold/50 mb-4"></div>
                    </div>
                  </div>
