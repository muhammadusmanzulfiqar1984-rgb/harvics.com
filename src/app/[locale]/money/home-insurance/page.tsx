            ...
            <div className="relative overflow-hidden bg-harvics-burgundy p-8 md:p-16 text-center text-white">
              ...
              <div className="relative z-10">
                ...
                <div className="max-w-md mx-auto">
                  <button className="w-full bg-white text-harvics-burgundy py-4 font-medium text-lg hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-lg">
                    Get Quote Now
                  </button>
                </div>
              </div>
