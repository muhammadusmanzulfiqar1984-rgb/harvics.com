          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                <div className="text-4xl mb-6 bg-[#6B1F2B]/5 w-16 h-16 flex items-center justify-center">🏠</div>
              ...
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                <div className="text-4xl mb-6 bg-[#6B1F2B]/5 w-16 h-16 flex items-center justify-center">🛡️</div>
            ...
            <div className="relative overflow-hidden bg-[#6B1F2B] p-8 md:p-16 text-center text-white">
              ...
              <div className="relative z-10">
                ...
                <div className="max-w-md mx-auto">
                  <button className="w-full bg-white text-[#6B1F2B] py-4 font-medium text-lg hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-lg">
                    Get Quote Now
                  </button>
                </div>
              </div>
