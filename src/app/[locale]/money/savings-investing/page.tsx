          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                <div className="text-4xl mb-6 bg-harvics-burgundy/5 w-16 h-16 flex items-center justify-center">💰</div>
                ...
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> High interest rates</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Easy access</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> No monthly fees</li>
                </ul>
              </div>
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                <div className="text-4xl mb-6 bg-harvics-burgundy/5 w-16 h-16 flex items-center justify-center">📈</div>
                ...
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Professional management</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Diversified portfolios</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Flexible options</li>
                </ul>
              </div>
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                <div className="text-4xl mb-6 bg-harvics-burgundy/5 w-16 h-16 flex items-center justify-center">🎯</div>
                ...
                <ul className="text-sm text-gray-500 space-y-2">
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Tax benefits</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Long-term growth</li>
                  <li className="flex items-center"><span className="text-harvics-burgundy mr-2">✓</span> Expert guidance</li>
                </ul>
              </div>
            </div>

            <div className="relative overflow-hidden bg-harvics-burgundy p-8 md:p-16 text-center">
              <div className="absolute inset-0">
