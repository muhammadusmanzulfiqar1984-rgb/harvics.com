        ...
        <section className="py-12 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-[#6B1F2B] border-2 border-[#6B1F2B]/20 rounded-xl p-8 shadow-lg">
              ...
              <div className="bg-[#6B1F2B] border-2 border-[#6B1F2B]/20 rounded-xl p-8 shadow-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['USD', 'EUR', 'GBP', 'AED', 'PKR', 'JPY'].map((currency) => (
                    <div key={currency} className="text-center p-4 bg-[#6B1F2B] rounded-lg">
            ...
            <div className="bg-gradient-to-r from-[#6B1F2B] to-[#6B1F2B] rounded-2xl p-8 md:p-12 text-white text-center">
              ...
              <button className="bg-gradient-to-r from-[#6B1F2B] to-[#6B1F2B] text-black px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-all duration-300">
                Order Now
              </button>
            </div>
          </div>
