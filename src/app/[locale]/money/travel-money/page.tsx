...
export default async function TravelMoneyPage({ params }: TravelMoneyPageProps) {
  ...
  return (
    <main className="min-h-screen bg-harvics-burgundy">
      <div className="pt-20">
        <section className="py-12 md:py-24 bg-gradient-to-br from-harvics-burgundy via-[#3D1212] to-harvics-burgundy">
        ...
        <section className="py-12 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-harvics-burgundy border-2 border-harvics-burgundy/20 p-8 shadow-lg">
              ...
              <div className="bg-harvics-burgundy border-2 border-harvics-burgundy/20 p-8 shadow-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['USD', 'EUR', 'GBP', 'AED', 'PKR', 'JPY'].map((currency) => (
                    <div key={currency} className="text-center p-4 bg-harvics-burgundy">
            ...
            <div className="bg-gradient-to-r from-harvics-burgundy to-harvics-burgundy p-8 md:p-12 text-white text-center">
              ...
              <button className="bg-gradient-to-r from-harvics-burgundy to-harvics-burgundy text-black px-8 py-4 font-bold text-lg hover:scale-105 transition-all duration-300">
                Order Now
              </button>
            </div>
          </div>
