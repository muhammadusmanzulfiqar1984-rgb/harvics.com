              ...
              <div className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="text-white bg-harvics-burgundy rounded-full w-8 h-8 flex items-center justify-center font-bold mr-4 flex-shrink-0">1</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="text-white bg-harvics-burgundy rounded-full w-8 h-8 flex items-center justify-center font-bold mr-4 flex-shrink-0">2</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="text-white bg-harvics-burgundy rounded-full w-8 h-8 flex items-center justify-center font-bold mr-4 flex-shrink-0">3</div>
                    <div>
