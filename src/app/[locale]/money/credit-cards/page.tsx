          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-white border border-gray-100 rounded-xl p-8 shadow-sm hover:shadow-lg transition-all duration-300">
                ...
                <button className="w-full bg-white border border-gray-200 text-gray-900 py-4 rounded-xl font-medium hover:bg-gray-50 hover:border-[#6B1F2B] hover:text-[#6B1F2B] transition-all duration-300">
                  Apply Now
                </button>
              </div>

              <div className="bg-white border-2 border-[#6B1F2B] rounded-xl p-8 shadow-xl transform md:-translate-y-4 relative overflow-hidden">
                ...
                <button className="w-full bg-[#6B1F2B] text-white py-4 rounded-xl font-medium hover:bg-[#2a0006] transition-all duration-300 shadow-lg">
                  Apply Now
                </button>
              </div>
