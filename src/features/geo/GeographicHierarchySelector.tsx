        ...
        return (
          <div key={level} className="flex items-center gap-4">
            ...
            <select
              ...
              className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-white disabled:bg-white disabled:cursor-not-allowed"
            >
