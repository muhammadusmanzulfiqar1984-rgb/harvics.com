    ...
    <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4">
      ...
      {selectedPath.length > 0 && (
        <div className="mb-4 pb-3 border-b border-[#333]">
          <button
            onClick={handleBack}
            className="text-white hover:text-harvics-gold/90 text-sm font-semibold flex items-center space-x-2 mb-2"
          >
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-semibold text-white group-hover:text-harvics-gold transition-colors">
                    {location.name}
                  </div>
              ...
              {location.children && location.children.length > 0 && (
                <svg className="w-5 h-5 text-black group-hover:text-harvics-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
