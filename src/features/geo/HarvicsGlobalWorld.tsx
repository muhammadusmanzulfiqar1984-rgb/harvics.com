...
const HarvicsGlobalWorld: React.FC<HarvicsGlobalWorldProps> = ({ onRegionChange }) => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.address.trim()) {
      errors.address = t('form.addressRequired')
    }
              ...
              <div className="mb-4 pb-3 border-b-2 border-[#6B1F2B] flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-black mt-1">
                    {t('form.selected')}: {COUNTRY_NAMES[selectedCountryCode || ''] || selectedCountryCode}
                  </p>
                </div>
                <button
                  type="button"
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="name" className="block text-sm font-bold text-black mb-1">
                    {t('form.fullName')} * {tCommon('required') ? `(${tCommon('required')})` : ''}
                  </label>
                  <input
                    type="text"
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-bold text-black mb-1">
                    {t('form.email')} * {tCommon('required') ? `(${tCommon('required')})` : ''}
                  </label>
                  <input
                    type="email"
                    id="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-sm font-bold text-black mb-1">
                    {t('form.phone')} * {tCommon('required') ? `(${tCommon('required')})` : ''}
                  </label>
                  <input
                    type="tel"
                    id="phone"
                ...
                <div>
                  <label htmlFor="address" className="block text-sm font-bold text-black mb-1">
                    {t('form.address')} * {tCommon('required') ? `(${tCommon('required')})` : ''}
                  </label>
                  <input
                    type="text"
                    id="address"
                ...
                <div className="flex space-x-3 pt-4">
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-gray-200 text-black font-bold rounded-md hover:bg-gray-300 transition-colors"
                  >
